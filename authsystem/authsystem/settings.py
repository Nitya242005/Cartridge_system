...
SECRET_KEY = 'django-insecure-an81fbh17ms(-6ag=v^i2_e@bz!e$i+$w_fypcwtsucrn9l1xr'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        'rest_framework.authentication.SessionAuthentication',         # Optional (useful for admin panel & dev)
        'rest_framework.authentication.BasicAuthentication',           # Optional (not needed in prod)
    ],
